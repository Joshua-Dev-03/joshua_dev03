...
Linux (Debian y Parrot OS)
Windows
QEMU/KVM y máquinas virtuales
Git y GitHub
Java
SQL
...
Dashboard con Tableau Public

Proyecto académico enfocado en la creación de un dashboard interactivo para visualizar y presentar información.

Aprendizaje: visualización de datos y creación de dashboards.
